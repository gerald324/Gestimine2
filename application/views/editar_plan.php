	...
	<div class="content">
		<div class="animated fadeIn">
			<div class="row">
				...
				<div class="col-lg-12">
					<form method="POST" action="<?= base_url('Planificador/update')?>">
						<div class="card">
							<div class="card-header">
								<strong class="card-title"><?php echo "Plan Minero"; ?></strong>
								<input type="submit" class="btn btn-primary" style="float:right"><?php echo "Editar"?>
							</div>
							<div class="card-body">
								<table class="table">
									...
									<tr>
										...
										<td><input type="text" name="seccion[]" value="<?php echo $parametros['seccion'] ?>"></td>
										<td><input type="text" name="area[]" value="<?php echo $parametros['area'] ?>"></td>
										<td><input type="text" name="largo_total[]" value="<?php echo $parametros['largo_total'] ?>"></td>
